...
* 0x02000000 = Enable Altivec java mode, basically makes it IEEE compilant. It's very important for this bit to be always enabled. No idea why there is even an option to disable it for x86 emulator...
