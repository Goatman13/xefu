cfg_base_default             = Without any mods this config is used by xefu7 when matching ID is not found in database. All other configs with cfg_base_default in name, includes those default settings.
