...
## Cfg14
This config contains Original Xbox memory addresses that mark range of skipped data and next address to be recompiled. This need to be confirmed, but it seems logical when the last field is 0 then recompilation stops completely (useful for data that is at the end of code segment). Value is a memory address to config data sets.
