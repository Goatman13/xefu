...
## Cfg10
This config contains 4 fields with params that change x86 recompilation and x86 pipeline emulation behavior. Each field is explained below. Value is a memory address to config data sets.
